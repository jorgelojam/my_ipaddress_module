##
##  Makefile -- Build procedure for sample my_ipaddress_module Apache module
...
#   cleanup
clean:
	-rm -f mod_my_ipaddress_module.o mod_my_ipaddress_module.lo mod_my_ipaddress_module.slo mod_my_ipaddress_module.la 
